...
module.exports = {
  ...
  output: {
    path: path.resolve(__dirname, 'build'), // diretório arquivo que vai ser gerado após ser convertido
    filename: 'bundle.js', // nome do arquivo que vai ser gerado pós conversão (bundle.js)
  },
  devServer: {
    contentBase: path.resolve(__dirname, 'build'), // caminho pro diretório onde contém os arquivos públicos da aplicação
    hot: true,
    historyApiFallback:{
      index:'/'
    },
